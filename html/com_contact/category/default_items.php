			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
					<?php if ($this->items[$i]->published == 0) : ?>
						<td class="system-unpublished cat-list-row<?php echo $i % 2; ?>">
					<?php else: ?>
						<td class="cat-list-row<?php echo $i % 2; ?>" >
					<?php endif; ?>

					<?php if ($this->params->get('show_telephone_headings') OR 
							 $this->params->get('show_mobile_headings') OR
					...
					<?php endif; ?>
						...
						<?php if ($this->params->get('show_position_headings') OR
								  $this->params->get('show_email_headings') OR
								  $this->params->get('show_suburb_headings') OR
								  $this->params->get('show_state_headings') OR
